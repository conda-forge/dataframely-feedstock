...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dataframely-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dataframely-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install dataframely
```
...
It is possible to list all of the versions of `dataframely` available on your platform:
...
```
pixi search dataframely --channel conda-forge
```
